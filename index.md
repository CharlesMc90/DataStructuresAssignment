...
# Problem 7: Print the 4th element in the array (element 4, not index 4)
print(cars[3])
...
# Problem 10: Remove element 5 of the array (not index 5)
cars.pop(4)
...
# Problem 16: Create a variable called my_array_length with the length of the cars array
my_array_length = len(cars)

# Problem 17: Create a variable called array_string with the specified value
